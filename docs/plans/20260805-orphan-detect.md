...
- [x] переместить этот план в `docs/plans/completed/` — отмечено выполненным, сам файл не перемещён: перенос делает харнесс после всех фаз ревью, ранний move сломал бы фазы, читающие план
