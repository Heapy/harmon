    ...
    companion object {
        fun forHome(home: String): UserSetupPaths {
            ...
            return UserSetupPaths(
                ...
                liveUiEndpoint = "$support/live-ui.endpoint",
                stagedAgentPlist = "$support/$AGENT_LABEL.pending.plist",
                ...
                previousAgentPlist =
                    "$home/Library/LaunchAgents/$PREVIOUS_AGENT_LABEL.plist",
...
object SystemSetupPaths {
    ...
    const val previousCollectorPlist =
        "$launchDaemonsDirectory/$PREVIOUS_COLLECTOR_LABEL.plist"
